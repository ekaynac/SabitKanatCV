...
cap = cv.VideoCapture(r"D:\GitHub\SabitKanatCV\RedDetection\bluedetection.mp4")
...
while(True):
    ...
    if ret:
        ...
        frame_hsv_blured = cv.GaussianBlur(frame_hsv,(5,5),0)
        ...
        mask_refined = cv.erode(mask, kernel_erosion, iterations=5)
        ...
        frame, x_list, y_list = cvDetector.drawRectangle(frame, contours, area_thresh= (0, 50000), rectangle_color=(255,0,0), rectangle_thickness=2)
